...
class BurgersFirebase extends StatefulWidget {
  const BurgersFirebase({Key? key}) : super(key: key);
  @override
  BurgersFirebaseState createState() => BurgersFirebaseState();
}

class BurgersFirebaseState extends State<BurgersFirebase> {
